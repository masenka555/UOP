...
public class DrawTextPanel extends JPanel  {
	...
	private ArrayList<DrawTextItem> listOfItems = new ArrayList<DrawTextItem>(); //store multiple items
	...
	private JTextField angleInput; // an input text angle
	private JTextField transparency; // an input text transparency
