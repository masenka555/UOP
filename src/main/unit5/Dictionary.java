...
public class Dictionary {
    public static void main(String[] args) throws FileNotFoundException {
        try {
            ...
            // Creating a new dictionary data structure
            HashSet<String> myhash = new HashSet();

            while (filein.hasNext()) {
                String tk = filein.next();

                //Adding words in dictionary from words.txt
                myhash.add(tk.toLowerCase());
            }
            ...
            while (userFile.hasNext() ) {
                ...
                if (!myhash.contains(two1) ) {
            System.out.println(two1 + ":" + corrections (two1, myhash ));
                }
            }
        }
